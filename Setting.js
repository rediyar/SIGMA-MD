...
global.owner = process.env.OWNER_NUMBER  || '94741897654' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '01_05_2024_SIGMA_MD_SUw0Suun_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
